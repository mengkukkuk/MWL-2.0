...
export function AllowancePage() {
  ...
  return (
    <Stack gap="xl">
      ...
      <Card padding="lg" className="filter-bar"><Group justify="space-between" wrap="wrap"><Group gap="sm"><Text fw={800}>Month</Text><PeriodSelect value={selectedMonth} onChange={setSelectedMonth} /></Group><Badge variant="light" color="cyan">{allowanceQuery.data?.length ?? 0} allowance days</Badge></Group></Card>
